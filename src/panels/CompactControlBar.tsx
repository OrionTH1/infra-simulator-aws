        ...
        <div className="flex flex-1 gap-1 rounded-card border border-border bg-surface p-1 shadow-card">
          {SECTIONS.map((section) => (
            <button
              ...
              className={`flex min-h-[40px] flex-1 cursor-pointer items-center justify-center gap-1 rounded-md px-2 font-sans text-[11px] font-medium uppercase tracking-wider transition-colors duration-150 ${
