    ...
    >
      ...
      {onRemove ? (
        <button
          ...
          className="card-remove press-ack nodrag absolute -top-2.5 -right-2.5 z-10 inline-flex h-5 w-5 cursor-pointer items-center justify-center rounded-full border border-border bg-surface-raised text-fg-muted opacity-0 shadow-card hover:border-status-error hover:text-status-error focus-visible:opacity-100 group-hover/card:opacity-100"
          onClick={(event) => {
