...
export function InfoTooltip({ text }: InfoTooltipProps) {
  return (
    <span
      className="group/info relative inline-flex h-4 w-4 items-center justify-center rounded-full border border-border text-fg-muted"
      tabIndex={0}
      aria-label={text}
    >
