...
export const RDS_INSTANCE_COLUMN_X = RDS_INSTANCE_X
export const RDS_INSTANCE_GAP = 56
export const FALLBACK_RDS_INSTANCE_HEIGHT = 96
export const REPLICATION_LANE_OFFSET = 54

export const RDS_WRITER_POSITION = { x: RDS_INSTANCE_X, y: ALB_POSITION.y - 160 }
