...
- **`MAX_IMAGE_PULL_SPEED_PX_PER_SECOND` = 2400.** O trajeto é orçado para durar exatamente o estágio `provisioning`, e esse estágio encolhe em relógio real conforme a escala de tempo sobe. Quando a travessia exigiria passar desse teto, o simulador **não desenha o pull** em vez de desenhar um borrão ou um pacote que sobrevive ao estágio. Na prática o fluxo é visível em 1× e 10×, e some em 25× e 60× — o controle de velocidade decide se o detalhe cabe.
